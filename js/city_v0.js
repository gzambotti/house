...
require([
  ...
  "dojo/domReady!"
], function(Map, FeatureLayer, Draw, Search, webMercatorUtils, Polygon, Point, Extent, geometryEngine, SpatialReference, Circle, Graphic, GraphicsLayer, 
  ...
  var statesColor = new Color("#000");
  var statesLine = new SimpleLineSymbol("solid", statesColor, 1.5);  
  var statesRenderer = new SimpleRenderer(statesLine);
  var bostonLayerURL = "http://services.arcgis.com/sFnw0xNflSi8J0uh/arcgis/rest/services/BostonBoundary/FeatureServer/0"
  //var bostonLayerURL = "http://services1.arcgis.com/qN3V93cYGMKQCOxL/arcgis/rest/services/bostonpoly/FeatureServer/0";
  var bostonLayer = new FeatureLayer(bostonLayerURL, {
    mode: FeatureLayer.MODE_AUTO
  });

  bostonLayer.setRenderer(statesRenderer);
  map.addLayer(bostonLayer);

  var jsonBostonBoundary = "http://services1.arcgis.com/qN3V93cYGMKQCOxL/arcgis/rest/services/bostonwgs2/FeatureServer/0/query?where=1+%3D1&objectIds=&time=&geometry=&geometryType=esriGeometryEnvelope&inSR=&spatialRel=esriSpatialRelIntersects&resultType=none&distance=&units=esriSRUnit_Meter&outFields=&returnGeometry=true&returnCentroid=false&multipatchOption=&maxAllowableOffset=&geometryPrecision=&outSR=&returnIdsOnly=false&returnCountOnly=false&returnExtentOnly=false&returnDistinctValues=false&orderByFields=&groupByFieldsForStatistics=&outStatistics=&resultOffset=&resultRecordCount=&returnZ=false&returnM=false&quantizationParameters=&sqlFormat=none&f=pjson";
  $.ajax({      
    type: "GET",
    dataType:'json',
  ...
  //var svgHouse = "M512,296l-96-96V56h-64v80l-96-96L0,296v16h64v160h160v-96h64v96h160V312h64V296z";
  ...
  function executeAlert(newmessage) {
    ...
    bootstrap_alert.info = function(message) {
          $('#alert_placeholder').append('<div class="alert alert-info alert-dismissable"><span>'+message+'</span></div>')
  ...
  function createBuffer(){
    ...
    map.on("dbl-click", function(evt){      
      ...
      var point = new Point(geoValues[0], geoValues[1], {"spatialReference":{"wkid":4326 }})
      console.log(zPolygon.contains(point))
  ...
  function addHouseHighZip(evt) {
    ...
    var geoValues = webMercatorUtils.xyToLngLat(evt.geometry.x, evt.geometry.y);
    var point = new Point(geoValues[0], geoValues[1], {"spatialReference":{"wkid":4326 }})
    var gPolygonBuffer = new Polygon(new esri.SpatialReference({wkid:4326}));            
